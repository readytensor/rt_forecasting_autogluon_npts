# NPTS Time-series Forecaster Model - AutoGluon

NPTS Forecaster for the Forecasting problem category as per Ready Tensor specifications.
...
- A **NPTS Forecaster** algorithm built using **AutoGluon**
